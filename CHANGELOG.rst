...
6.5.0 (29.12.2025)
------------------
- Использование корректных версий драйверов под архитектуры `arm64`, `x86`
- Обновление драйвера Атол до 10.10.8.0
- Поддержка НДС 22%
- Удаление неиспользуемого функционала установки пароля для входа в веб-интерфейсе

6.4.2 (19.09.2025)
------------------
- Использование корректной версии драйвера при архитектуре ОС 'aarch64'

6.4.1 (18.09.2025)
------------------
- Корректная обработка данных кассира

6.4.0 (08.09.2025)
------------------
- Обработка планируемого статуса

6.3.0 (22.08.2025)
------------------
- Добавлена возможность передачи контактов покупателя для чеков коррекции ФФД 1.05
- Добавлена обработка реквизита "Дополнительные сведения о безналичной оплате" для ФФД 1.05 и ФФД 1.2
- Добавлена обработка реквизита "Интернет" для ФФД 1.05 и ФФД 1.2
- Номер предписания налогового органа теперь обязателен только для коррекции по предписанию для ФФД 1.05

6.2.2 (19.08.2025)
------------------
- Обновление драйвера Атол до 10.10.7.0
